...
function Cart() {
    const { cartTotals, currency, updateQuantity } = useContext(shopDataContext)
    ...
    <div className='w-full min-h-screen px-4 md:px-8 overflow-hidden bg-gradient-to-l from-[#141414] to-[#0c2025] pb-[100px]'>
      <div className='max-w-6xl mx-auto'>
        ...
        <div className='space-y-4'>
          <AnimatePresence>
          {
           cartTotals.lineItems.map((item,index)=>{
                    ...
                    <div className='flex flex-wrap md:flex-nowrap items-center gap-3 md:gap-5'>
                        ...
                        <div className='flex-1 min-w-0'>
                            ...
                            <div className='flex items-center gap-2 mt-1.5'>
                                <p className='text-[14px] md:text-[16px] text-[#0ea5e9] font-semibold'>{currency} {item.price}</p>
                            ...
                            <button
                              ...
                              onClick={() => {
                                if (sizeInventory && availableStock > 0 && item.quantity >= availableStock) {
                                  toast.warning(`Only ${availableStock} available for ${item.name} (${item.size})`)
                                  return
                                }
          ...
          <div className='flex justify-end mt-12'>
            <div className='w-full sm:w-[450px]'>
                ...
                <button 
                  ...
                  onClick={()=>{
                    if (cartTotals.lineItems.length > 0) { navigate("/placeorder"); }
